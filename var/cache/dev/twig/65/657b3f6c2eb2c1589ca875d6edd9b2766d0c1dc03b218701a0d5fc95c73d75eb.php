...
/* blog/_rss.html.twig */
class __TwigTemplate_57ca6e0bedc1209bd6ab0016e7fd64ca0d16042b9a4ad9de007b4003449df22f extends Twig_Template
{
    private $source;
    ...
    <a href=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_rss", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 2, $this->source); })()), "request", array()), "query", array()), "all", array())), "html", null, true);
        echo "\">
...
", "blog/_rss.html.twig", "/home/dev/Projects/oc/zozor-blog/templates/blog/_rss.html.twig");
    }
}
