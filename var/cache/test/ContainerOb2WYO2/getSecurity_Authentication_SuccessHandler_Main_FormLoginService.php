...
$instance->setOptions(array('login_path' => 'security_login', 'default_target_path' => 'blog_index', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
