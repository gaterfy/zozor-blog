...
return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('Twig\\Extensions\\IntlExtension' => function () {
    return ($this->privates['Twig\Extensions\IntlExtension'] ?? $this->privates['Twig\Extensions\IntlExtension'] = new \Twig\Extensions\IntlExtension());
}, 'App\\DataFixtures\\AppFixtures' => function () {
    return ($this->privates['App\DataFixtures\AppFixtures'] ?? $this->load('getAppFixturesService.php'));
}, 'App\\EventSubscriber\\CheckRequirementsSubscriber' => function () {
    return ($this->privates['App\EventSubscriber\CheckRequirementsSubscriber'] ?? $this->load('getCheckRequirementsSubscriberService.php'));
}, 'App\\EventSubscriber\\CommentNotificationSubscriber' => function () {
...
}, 'App\\EventSubscriber\\ControllerSubscriber' => function () {
...
}, 'App\\Form\\PostType' => function () {
    return ($this->privates['App\Form\PostType'] ?? $this->privates['App\Form\PostType'] = new \App\Form\PostType());
}, 'App\\Form\\Type\\DateTimePickerType' => function () {
    return ($this->privates['App\Form\Type\DateTimePickerType'] ?? $this->load('getDateTimePickerTypeService.php'));
}, 'App\\Form\\Type\\TagsInputType' => function () {
    return ($this->privates['App\Form\Type\TagsInputType'] ?? $this->load('getTagsInputTypeService.php'));
...
}, 'App\\Security\\PostVoter' => function () {
    return ($this->privates['App\Security\PostVoter'] ?? $this->privates['App\Security\PostVoter'] = new \App\Security\PostVoter());
}, 'App\\Twig\\AppExtension' => function () {
    return ($this->privates['App\Twig\AppExtension'] ?? $this->getAppExtensionService());
}, 'App\\Twig\\SourceCodeExtension' => function () {
    return ($this->privates['App\Twig\SourceCodeExtension'] ?? $this->privates['App\Twig\SourceCodeExtension'] = new \App\Twig\SourceCodeExtension());
}, 'App\\Utils\\Markdown' => function () {
    return ($this->privates['App\Utils\Markdown'] ?? $this->privates['App\Utils\Markdown'] = new \App\Utils\Markdown());
}, 'App\\Utils\\MomentFormatConverter' => function () {
    return ($this->privates['App\Utils\MomentFormatConverter'] ?? $this->privates['App\Utils\MomentFormatConverter'] = new \App\Utils\MomentFormatConverter());
    ...
    return ($this->privates['file_locator'] ?? $this->privates['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel')), ($this->targetDirs[3].'/src/Resources'), array(0 => ($this->targetDirs[3].'/src'))));
}, 'uri_signer' => function () {
    return ($this->privates['uri_signer'] ?? $this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner($this->getEnv('APP_SECRET')));
...
}, 'fragment.renderer.esi' => function () {
    return ($this->privates['fragment.renderer.esi'] ?? $this->load('getFragment_Renderer_EsiService.php'));
    ...
    return ($this->privates['assets._version__default'] ?? $this->privates['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy(($this->targetDirs[3].'/public/build/manifest.json')));
    ...
    return ($this->privates['esi'] ?? $this->privates['esi'] = new \Symfony\Component\HttpKernel\HttpCache\Esi());
}, 'esi_listener' => function () {
...
}, 'security.user.provider.concrete.database_users' => function () {
    return ($this->privates['security.user.provider.concrete.database_users'] ?? $this->load('getSecurity_User_Provider_Concrete_DatabaseUsersService.php'));
...
}, 'security.authentication.listener.basic.main' => function () {
    return ($this->privates['security.authentication.listener.basic.main'] ?? $this->load('getSecurity_Authentication_Listener_Basic_MainService.php'));
    ...
    return ($this->privates['sensio_framework_extra.view.guesser'] ?? $this->privates['sensio_framework_extra.view.guesser'] = new \Sensio\Bundle\FrameworkExtraBundle\Templating\TemplateGuesser(($this->services['kernel'] ?? $this->get('kernel'))));
    ...
    return ($this->privates['twig.template_iterator'] ?? $this->privates['twig.template_iterator'] = new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel')), ($this->targetDirs[3].'/src'), array(($this->targetDirs[3].'/vendor/symfony/twig-bridge/Resources/views/Form') => NULL)));
    ...
    return ($this->privates['white_october_pagerfanta.view_factory'] ?? $this->getWhiteOctoberPagerfanta_ViewFactoryService());
    ...
    return ($this->privates['pagerfanta.view.default_translated'] ?? $this->getPagerfanta_View_DefaultTranslatedService());
    ...
    return ($this->privates['pagerfanta.view.twitter_bootstrap4_translated'] ?? $this->getPagerfanta_View_TwitterBootstrap4TranslatedService());
}, 'pagerfanta.view.twitter_bootstrap3_translated' => function () {
    return ($this->privates['pagerfanta.view.twitter_bootstrap3_translated'] ?? $this->getPagerfanta_View_TwitterBootstrap3TranslatedService());
}, 'pagerfanta.view.twitter_bootstrap_translated' => function () {
    return ($this->privates['pagerfanta.view.twitter_bootstrap_translated'] ?? $this->getPagerfanta_View_TwitterBootstrapTranslatedService());
}, 'pagerfanta.view.semantic_ui_translated' => function () {
    return ($this->privates['pagerfanta.view.semantic_ui_translated'] ?? $this->getPagerfanta_View_SemanticUiTranslatedService());
}, 'twig.extension.pagerfanta' => function () {
    return ($this->privates['twig.extension.pagerfanta'] ?? $this->getTwig_Extension_PagerfantaService());
...
}, 'dama.doctrine.dbal.connection_factory' => function () {
    return ($this->privates['dama.doctrine.dbal.connection_factory'] ?? $this->load('getDama_Doctrine_Dbal_ConnectionFactoryService.php'));
}, 'doctrine.orm.default_metadata_cache' => function () {
    return ($this->privates['doctrine.orm.default_metadata_cache'] ?? $this->load('getDoctrine_Orm_DefaultMetadataCacheService.php'));
}, 'doctrine.orm.default_query_cache' => function () {
    return ($this->privates['doctrine.orm.default_query_cache'] ?? $this->load('getDoctrine_Orm_DefaultQueryCacheService.php'));
...
}, 'dama.doctrine.dbal.connection_factory.inner' => function () {
    return ($this->privates['dama.doctrine.dbal.connection_factory.inner'] ?? $this->privates['dama.doctrine.dbal.connection_factory.inner'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array()));
    ...
    return ($this->privates['.service_locator.yj1g8Ib'] ?? $this->load('get_ServiceLocator_Yj1g8IbService.php'));
