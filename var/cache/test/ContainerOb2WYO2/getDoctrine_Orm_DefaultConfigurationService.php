...
$instance->setMetadataCacheImpl(($this->privates['doctrine.orm.default_metadata_cache'] ?? $this->load('getDoctrine_Orm_DefaultMetadataCacheService.php')));
$instance->setQueryCacheImpl(($this->privates['doctrine.orm.default_query_cache'] ?? $this->load('getDoctrine_Orm_DefaultQueryCacheService.php')));
